...
namespace JamesonBugTracker.Data
{
        ...
        public static class DataUtility
    {
        ...
        public static async Task SeedDefaultCompanyAsync(ApplicationDbContext context)
        {
            try
            {
                IList<Company> defaultCompany = new List<Company>() {
                    ...
                    new Company() { Name = "Stark Industries", Description="This is default Company 3" },
                ...
                company3Id = context.Company.FirstOrDefault(p => p.Name == "Stark Industries").Id;
            ...
            try
            {
                IList<Project> projects = new List<Project>() {
                     new Project()
                     {
                         ...
                         EndDate = new DateTime(2021,3,4).AddMonths(3),
        ...
        public static async Task SeedDefaultUsersAsync(UserManager<BTUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            {
                UserName = "hpym@mailinator.com",
                Email = "hpym@mailinator.com",
                FirstName = "Hank",
                LastName = "Pym",
                EmailConfirmed = true,
                CompanyId = company3Id
