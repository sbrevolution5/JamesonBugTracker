...
namespace JamesonBugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Created,FileName,FileContentType,FileData,TicketId,UserId")] TicketAttachment ticketAttachment)
        {
